 ...
 *
 * Imports `FoldersModule` for the workspace-scoped folder lookup that validates
 * `folderId` on create/move/import, `OrganizationsModule` for resolving a
 * request's workspace, and `StorageModule` for the S3 client. The dependencies
