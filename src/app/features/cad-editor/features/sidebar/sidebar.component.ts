...
interface SidebarBtn {
  ...
  /** Translation key of the button caption (also used as its tooltip). */
  labelKey: string;
  svg: string;
}
...
const BUTTONS: SidebarBtn[] = [
  {
    id: 'properties',
    labelKey: 'editor.ui.sidebar.properties',
  ...
  {
    id: 'layers',
    labelKey: 'editor.ui.sidebar.layers',
  ...
  {
    id: 'blocks',
    labelKey: 'editor.ui.sidebar.blocks',
  ...
  {
    id: 'viewports',
    labelKey: 'editor.ui.sidebar.viewports',
  ...
  {
    id: 'library',
    labelKey: 'editor.ui.sidebar.library',
  ...
  {
    id: 'ai-agent',
    labelKey: 'editor.ui.sidebar.aiAgent',
...
const SETTINGS_BTN: SidebarBtn = {
  id: 'settings' as any,
  labelKey: 'editor.ui.sidebar.settings',
...
@Component({
  ...
  template: `
    <div class="cad-sidebar" *transloco="let t">
      @for (b of buttons; track b) {
        <button
          ...
          <span class="sb-label">{{ t(b.labelKey) }}</span>
        </button>
      }
