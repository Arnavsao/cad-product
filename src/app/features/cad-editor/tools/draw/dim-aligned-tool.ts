...
export class DimAlignedTool implements ITool {
  ...
  getDynamicInputState(): IDynamicInputState | null {
    ...
    return { wx: this.cur.x, wy: this.cur.y, fields: [{ key: 'length', label: 'Length', liveValue: formatLen(len), readonly: true, width: 80 }] };
  }
